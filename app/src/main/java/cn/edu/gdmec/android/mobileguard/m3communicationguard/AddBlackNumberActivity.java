...
public class AddBlackNumberActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initView(){
        ...
        mLjmodeET = (EditText) findViewById(R.id.et_blackljmode);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data){
        ...
        if (data != null){
            ...
            String ljmode = data.getStringExtra("ljmode");
            mNameET.setText(name);
            mNumET.setText(phone);
            mLjmodeET.setText(ljmode);
        }
    }
    ...
    public void onClick(View view) {
        switch (view.getId()){
            ...
            case R.id.add_blacknum_btn:
                ...
                String ljmode = mLjmodeET.getText().toString().trim();
                if (TextUtils.isEmpty(number)||TextUtils.isEmpty(name)){
                    ...
                    blackContactInfo.lanjieMode = ljmode;
                    ...
                    if (!dao.IsNumberExist(blackContactInfo.phoneNumber)){
                        ...
                        Toast.makeText(this,"该号码已经被添加至名单",Toast.LENGTH_SHORT).show();
                    }
                    finish();
                }
                break;
