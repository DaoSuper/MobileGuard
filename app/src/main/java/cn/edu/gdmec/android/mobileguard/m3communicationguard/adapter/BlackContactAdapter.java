...
public class BlackContactAdapter extends BaseAdapter {
    ...
    public View getView( final int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null){
            ...
            holder.mLjmodeTV = (TextView) view.findViewById(R.id.tv_black_ljmode);
        ...
        holder.mLjmodeTV.setText(contactInfos.get(i).lanjieMode);
        ...
        holder.mLjmodeTV.setTextColor(context.getResources().getColor(R.color.bright_purple));
