...
public class AppLockService extends Service {
    ...
    private String  tempStoppProtectpackname;
    ...
    class AppLockReceiver extends BroadcastReceiver{
        ...
        public void onReceive(Context context, Intent intent) {
            if (App.APPLOCK_ACTION.equals(intent.getAction())){
                tempStoppProtectpackname = intent.getStringExtra("packagename");
            }else if (Intent.ACTION_SCREEN_OFF.equals(intent.getAction())){

                tempStoppProtectpackname = null;
                //停止监控程序
                flag = false;
            ...
            public void run(){
                ...
                while (flag){
                    ...
                    if (packagenames.contains(pacagekname)){
                        ...
                        if (!pacagekname.equals(tempStoppProtectpackname)){
                            //需要保护
                            //弹出一个输入密码的界面
